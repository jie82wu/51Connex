...
<div class="wrap">
	...
	<div class="wprps-notice">
		<a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=22030&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade</a> a plugin within a minute and unloack many features now!!!
	</div>
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=22030&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade Now</a></td>
	    	</tr>
	    </tfoot>
	     ...
	     <tbody>
			...
			<tr>
				<th>Option Show/Hide Title  <span>Display Post title</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr> 
			<tr>
				<th>Pagination Support  <span>Pagination support for any shortcode</span></th>
				<td><i class="dashicons dashicons-yes"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>    			
			<tr>
			...
			<tr>
				<th>Show/hide image caption <span>Slider caption show/hide </span></th>
				<td><i class="dashicons dashicons-yes"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
