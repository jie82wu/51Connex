...
function msacwl_gallery_carousel( $atts, $content ) {
	...
	if( $images ): ?>
		<div class="msacwl-carousel-wrap msacwl-row-clearfix">
			<div id="msacwl-carousel-<?php echo $unique; ?>" class="msacwl-carousel msacwl-slider-popup">
				<div class="msacwl-gallery-carousel">
				<?php foreach( $images as $image ): 						
					$post_mata_data = get_post($image);?>
					<div class="msacwl-carousel-slide msacwl-slide" data-item-index="<?php echo $count; ?>">							
